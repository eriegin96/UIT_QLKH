...
public class SalesPage extends javax.swing.JPanel {
    ...
    public final void initTable() {
        ...
        String[] headerTbl = new String[] { "Mã bán", "Ngày", "Mã SP", "Tên SP", "Mã KH", "Tên KH", "Số lượng",
                "Doanh thu", "Người bán" };
                        ...
                        .addGroup(sellPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(sellPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(sellPanelLayout.createSequentialGroup()
                                                ...
                                                .addComponent(custCombo, 0, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        Short.MAX_VALUE))
                                        .addGroup(sellPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(sellPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(sellPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 24,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(custCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 29,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                ...
                                .addGroup(sellPanelLayout
                                        ...
                                        .addComponent(jLabel3, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(prodCombo, javax.swing.GroupLayout.DEFAULT_SIZE, 24,
                                                Short.MAX_VALUE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                ...
                                .addGroup(sellPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(deleteButton, javax.swing.GroupLayout.PREFERRED_SIZE, 31,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(sellButton, javax.swing.GroupLayout.PREFERRED_SIZE, 31,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    public void loadDataSet() {
        try {
            ...
            while (rs.next()) {
                ...
                tblModel.addRow(new Object[] { salesCode, date, productCode, productName, customerCode, customerName,
                        quantity, formattedRevenue, soldBy });
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
