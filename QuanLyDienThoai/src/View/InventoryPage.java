...
public class InventoryPage extends javax.swing.JPanel {
    ...
    public final void initTable() {
        ...
        String[] headerTbl = new String[] { "Mã SP", "Tên sản phẩm", "Số lượng", "Giá gốc", "RAM", "ROM",
                "Kích thước MH", "Hãng" };
    ...
    public void loadDataSet() {
        try {
            ...
            while (rs.next()) {
                ...
                tblModel.addRow(new Object[] { productCode, productName, quantity, formattedCostPrice, ram, rom,
                        screenSize, brand });
            }
