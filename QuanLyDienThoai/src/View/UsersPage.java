...
public class UsersPage extends javax.swing.JPanel {
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_addButtonActionPerformed
        ...
        if (nameText.getText().equals("") || locationText.getText().equals("") || phoneText.getText().equals("")
                || usernameText.getText().equals("") || passText.getPassword().length == 0)
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_editButtonActionPerformed
        ...
        // Use the original selected username for WHERE clause, but allow updating to
        // new username
        userDTO.setUsername(selectedUsername); // Original username for WHERE clause
        userDTO.setUserType(userType);

        // Check if password field has been filled (meaning user wants to change
        // password)
