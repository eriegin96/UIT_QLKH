...
public class DialogProductDetail extends javax.swing.JDialog {

    /**
     * Creates new form DialogProductDetail
     */
    private LayoutProduct owner;
    DecimalFormat formatter = new DecimalFormat("###,###,###");
    
    public DialogProductDetail(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) {
        super(owner, modal);       
        initComponents();
    ...
    private DialogProductDetail(JFrame jFrame, boolean b) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogProductDetail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogProductDetail dialog = new DialogProductDetail(new javax.swing.JFrame(), true);
