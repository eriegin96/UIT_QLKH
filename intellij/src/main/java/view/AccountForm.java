...
public class AccountForm extends javax.swing.JInternalFrame {
        ...
        try {
            ...
            for (Account i : acc) {
                tblModel.addRow(new Object[] {
                        i.getFullName(), i.getUser(), i.getEmail(), i.getRole(),
                        i.getStatus() == 0 ? "Đã khóa" : "Hoạt động"
                });
            }
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        btnEditAccount1
                .setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8-update-left-rotation-40.png"))); // NOI18N
        ...
        exportExcel
                .setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8_spreadsheet_file_40px.png"))); // NOI18N
        ...
        cbxLuachon.setModel(new javax.swing.DefaultComboBoxModel<>(
                new String[] { "Tất cả", "Tên tài khoản", "Tên đăng nhập", "Vai trò" }));
    ...
    private void btnEditAccountActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnEditAccountActionPerformed
        ...
        if (tblAccount.getSelectedRow() == -1) {
            ...
            if (getAccountSelect().getRole().equals("ADMIN")) {
                JOptionPane.showMessageDialog(this, "Không thể sửa tài khoản admin tại đây !", "Cảnh báo",
    ...
    private void btnEditAccount1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnEditAccount1ActionPerformed
        ...
        if (tblAccount.getSelectedRow() == -1) {
            ...
            int check = JOptionPane.showConfirmDialog(this, "Bạn có muổn reset tài khoản này ?", "Reset",
