...
1. Tải source code về:
   ...
   ```bash
   git clone https://github.com/eriegin96/UIT_QLKH
   ```

2. Mở xampp và vào trang http://localhost/phpmyadmin/ tạo 1 database mới có tên là quanlykhohang và import cơ sở dữ liệu trong folder database trong source code.
