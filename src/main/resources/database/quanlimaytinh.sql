...
--
-- Host: localhost
-- Generation Time: Dec 17, 2026 01 04:53 AM
...
INSERT INTO `MayTinh` (`maMay`, `tenMay`, `soLuong`, `tenCpu`, `ram`, `vga`, `gia`, `mainBoard`, `congSuatNguon`, `loaiMay`, `rom`, `kichThuocMan`, `dungLuongPin`, `xuatXu`, `trangThai`) VALUES
...
('ANPHAT', 'CÔNG TY CỔ PHẦN THƯƠNG MẠI MÁY TÍNH AN PHÁT', '19000323 ', 'Tầng 5, Số 49 phố Thái Hà, Phường Đống Đa, Thành phố Hà Nội, Việt Nam.'),
...
('GEARVN', 'CÔNG TY TNHH THƯƠNG MẠI GEARVN', '1900 5301', '82 Hoàng Hoa Thám, Phường 12, Tân Bình, Thành phố Hồ Chí Minh'),
('TINHOCNGOISAO', 'Công Ty Cổ Phần Bán Lẻ Kỹ Thuật Số TINHOCNGOISAO', '02873023456', '28 - 30 Trần Triệu Luật, P.Tân Hoà, TP.HCM'),
('MEMORYZONE', 'CÔNG TY TNHH DỊCH VỤ TIN HỌC SIÊU TỐC', '02873013878', '22 Nguyễn Hoàng, Phường Bình Trưng, Thành phố Hồ Chí Minh, Việt Nam.'),
...
('KCC', 'CÔNG TY TNHH THƯƠNG MẠI DỊCH VỤ VÀ CÔNG NGHỆ KCCSHOP', '0912.074.444', '8B Lý Thường Kiệt, Phường 12, Quận 5, TP.HCM'),
('NGUYENCONG', 'CÔNG TY TNHH MÁY TÍNH NGUYỄN CÔNG', '089.9999.191', '17 Hà Kế Tấn - Phường Phương Liệt - Hà Nội');
...
('PN1', '2026-01-01 13:59:09', 'admin', 'TINHOCNGOISAO', 42980000),
('PN10', '2026-01-07 18:04:19', 'admin', 'MEMORYZONE', 112440000),
('PN11', '2026-01-07 18:48:21', 'admin', 'NGUYENCONG', 98300000),
('PN12', '2026-01-16 02:19:48', 'admin', 'HACOM', 39880000),
('PN13', '2026-01-16 02:19:36', 'admin', 'PHONGVU', 38980000),
('PN14', '2026-01-08 12:28:57', 'admin', 'TINHOCNGOISAO', 50970000),
('PN15', '2026-01-08 12:36:25', 'admin', 'KCC', 39980000),
('PN16', '2026-01-08 16:30:48', 'thao', 'MEMORYZONE', 52170000),
('PN17', '2026-01-09 14:29:43', 'admin', 'KCC', 30180000),
('PN18', '2026-01-09 17:08:19', 'tin', 'HACOM', 78750000),
('PN19', '2026-01-12 07:09:21', 'admin', 'PHONGVU', 66860000),
('PN2', '2026-01-01 13:59:23', 'admin', 'TINHOCNGOISAO', 46780000),
('PN20', '2026-01-13 19:46:37', 'admin', 'PHONGVU', 233270000),
('PN21', '2026-01-14 11:54:21', 'admin', 'PHONGVU', 1536180000),
('PN22', '2026-01-14 12:32:09', 'admin', 'TINHOCNGOISAO', 89660000),
('PN23', '2026-01-14 14:28:52', 'thao', 'KCC', 112540000),
('PN24', '2026-01-14 14:41:23', 'admin', 'KCC', 2339800000),
('PN25', '2026-01-14 15:18:25', 'admin', 'ANPHAT', 22490000),
('PN26', '2026-01-14 20:01:37', 'admin', 'GEARVN', 50380000),
('PN27', '2026-01-14 20:02:31', 'admin', 'ANPHAT', 192900000),
('PN28', '2026-01-15 10:43:36', 'admin', 'ANPHAT', 71870000),
('PN29', '2026-01-16 02:19:55', 'admin', 'GEARVN', 10690000),
('PN3', '2026-01-03 03:58:18', 'admin', 'TINHOCNGOISAO', 88450000),
('PN30', '2026-01-15 23:13:22', 'admin', 'ANPHAT', 59480000),
('PN31', '2026-01-15 23:14:59', 'thao', 'ANPHAT', 58370000),
('PN32', '2026-01-16 02:19:27', 'admin', 'MEMORYZONE', 80260000),
('PN33', '2026-01-16 13:09:45', 'thao', 'NGUYENCONG', 68070000),
('PN34', '2026-01-16 15:31:14', 'admin', 'MEMORYZONE', 513500000),
('PN35', '2026-01-16 15:36:48', 'admin', 'MEMORYZONE', 59760000),
('PN36', '2026-01-16 15:40:31', 'admin', 'ANPHAT', 389800000),
('PN37', '2026-01-17 01:02:09', 'tin', 'GEARVN', 85350000),
('PN38', '2026-01-17 01:08:48', 'admin', 'ANPHAT', 838500000),
('PN4', '2026-01-03 03:58:37', 'admin', 'KCC', 53270000),
('PN5', '2026-01-06 17:51:02', 'admin', 'HACOM', 32070000),
('PN6', '2026-01-06 18:50:32', 'admin', 'NGUYENCONG', 38190000),
('PN7', '2026-01-06 18:59:43', 'admin', 'PHONGVU', 135530000),
('PN8', '2026-01-06 19:15:01', 'admin', 'TINHOCNGOISAO', 46670000),
('PN9', '2026-01-06 19:20:44', 'admin', 'NGUYENCONG', 43480000);
...
('PX1', '2026-01-01 14:10:44', 'admin', 291860000),
('PX10', '2026-01-07 18:41:08', 'admin', 57160000),
('PX12', '2026-01-07 19:06:56', 'admin', 45370000),
('PX13', '2026-01-08 12:31:48', 'tin', 109420000),
('PX14', '2026-01-08 16:30:10', 'tin', 78650000),
('PX15', '2026-01-12 22:31:09', 'tin', 86850000),
('PX16', '2026-01-14 15:04:47', 'admin', 136740000),
('PX17', '2026-01-14 15:34:07', 'admin', 51980000),
('PX18', '2026-01-15 20:32:57', 'admin', 151730000),
('PX19', '2026-01-16 02:20:15', 'phuong', 59360000),
('PX2', '2026-01-04 16:45:43', 'admin', 70660000),
('PX20', '2026-01-16 13:26:33', 'phuong', 79140000),
('PX21', '2026-01-16 13:36:43', 'phuong', 60850000),
('PX22', '2026-01-16 16:39:41', 'phuong', 35780000),
('PX23', '2026-01-16 17:18:54', 'phuong', 41460000),
('PX24', '2026-01-16 17:25:10', 'phuong', 63360000),
('PX25', '2026-01-16 18:51:31', 'phuong', 92550000),
('PX26', '2026-01-17 00:19:47', 'phuong', 94760000),
('PX3', '2026-01-04 16:45:52', 'admin', 89350000),
('PX4', '2026-01-04 16:45:59', 'tin', 58170000),
('PX5', '2026-01-06 19:10:13', 'admin', 85250000),
('PX6', '2026-01-06 19:19:12', 'admin', 71460000),
('PX7', '2026-01-06 19:25:43', 'tin', 52370000),
('PX8', '2026-01-07 18:39:54', 'admin', 39880000),
('PX9', '2026-01-07 18:40:22', 'tin', 36680000);
